...
const ProfileView = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-md mt-6">
      ...
      <p>
        <strong>Specialisation:</strong> {profile.specialisation}
      </p>
      <p>
        <strong>Age:</strong> {profile.age}
      </p>
      <p>
        <strong>Year Joined Hospital:</strong> {profile.year_joined_hospital}
      </p>

      <section className="">
        <button
          className="border-2 border-orange-500 rounded-md px-4"
